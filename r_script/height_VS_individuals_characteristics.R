...
# CHDI
a <- ggplot(data = filter(lizards_Id_good_sample_species, species_code == "CHDI")) + geom_point(mapping = aes(x = SVL_cm, y = height_found_m))  + geom_smooth(mapping = aes(x = SVL_cm, y = height_found_m), method = "lm") + labs(title = "Height_VS_SVL, CHDI", x = "SVL (cm)", y = "Height (m)") + theme_bw(base_size = 23)
...
# HEMA
a <- ggplot(data = filter(lizards_Id_good_sample_species, species_code == "HEMA")) + geom_point(mapping = aes(x = SVL_cm, y = height_found_m))  + geom_smooth(mapping = aes(x = SVL_cm, y = height_found_m), method = "lm") + labs(title = "Height_VS_SVL, HEMA", x = "SVL (cm)", y = "Height (m)") + theme_bw(base_size = 23)
...
# HEMI
a <- ggplot(data = filter(lizards_Id_good_sample_species, species_code == "HEMI")) + geom_point(mapping = aes(x = SVL_cm, y = height_found_m))  + geom_smooth(mapping = aes(x = SVL_cm, y = height_found_m), method = "lm") + labs(title = "Height_VS_SVL, HEMI", x = "SVL (cm)", y = "Height (m)") + theme_bw(base_size = 23)
...
# HEPL
a <- ggplot(data = filter(lizards_Id_good_sample_species, species_code == "HEPL")) + geom_point(mapping = aes(x = SVL_cm, y = height_found_m))  + geom_smooth(mapping = aes(x = SVL_cm, y = height_found_m), method = "lm") + labs(title = "Height_VS_SVL, HEPL", x = "SVL (cm)", y = "Height (m)") + theme_bw(base_size = 23)
...
# LYMO
a <- ggplot(data = filter(lizards_Id_good_sample_species, species_code == "LYMO")) + geom_point(mapping = aes(x = SVL_cm, y = height_found_m))  + geom_smooth(mapping = aes(x = SVL_cm, y = height_found_m), method = "lm") + labs(title = "Height_VS_SVL, LYMO", x = "SVL (cm)", y = "Height (m)") + theme_bw(base_size = 23)
...
plot_grid(graph1, graph2, graph3, graph4, graph5, ncol=2, labels=c("A", "B", "C", "D", "E"), label_size = 23)
dev.off()
